        ...
        <div className="flex flex-col justify-center items-center w-full h-full mx-auto p-4">
            ...
            <div className="max-w-[900px] w-full grid sm:grid-cols-2 gap-8 px-4">
                ...
                >
                    ...
                    I am proficient in Javascript, React, HTML, CSS, Express JS, & MySQL. 
                    I have some experience with/am currently learning Typescript & Next.JS (and Python, eventually...).
